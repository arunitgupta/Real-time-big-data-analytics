...
//    private RenderMode renderMode = RenderMode.SQUARE;
            ...
            if (this.matcher4.findMatches(kpl)
                ...
                try {
                    ...
                    if (modelImage4.getBounds().transform(boundsToPoly).isConvex()) {
                        ...
                        renderer.drawText(new AttributedString("Breast cancer cells"),(int)this.modelImage4.getBounds().getTopLeft().getX()+25,10);
                        if (count4 <= 10) {
    ...
    public void LoadReferenceObject() {
        ...
        try {
            ...
            modelImage4 = ImageUtilities.readMBF(new File("data/Prostate.png"));
        } catch (IOException e) {
            e.printStackTrace();
        }
